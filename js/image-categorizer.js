...
class ImageCategorizer {
  ...
  getKnownImages() {
    return [
      { name: 'arac-kismi-2', path: 'img/services/arac-kismi-2' },
      { name: 'arac-kismi-3', path: 'img/services/arac-kismi-3' },
      { name: 'arac-tam-1', path: 'img/services/arac-tam-1' },
      { name: 'baski-afis-3', path: 'img/services/baski-afis-3' },
      { name: 'baski-afis-4', path: 'img/services/baski-afis-4' },
      { name: 'baski-folyo-1', path: 'img/services/baski-folyo-1' },
      { name: 'baski-poster-2', path: 'img/services/baski-poster-2' },
      { name: 'hediye-1', path: 'img/services/hediye-1' },
      { name: 'plaket-gümüş-2', path: 'img/services/plaket-gümüş-2' },
      { name: 'plaket-kadife-1', path: 'img/services/plaket-kadife-1' },
      { name: 'plaket-kristal-3', path: 'img/services/plaket-kristal-3' },
      { name: 'promosyon-ajanda-3', path: 'img/services/promosyon-ajanda-3' },
      { name: 'promosyon-çakmak-2', path: 'img/services/promosyon-çakmak-2' },
      { name: 'promosyon-kalem-1', path: 'img/services/promosyon-kalem-1' },
      { name: 'promosyon-kupa-2', path: 'img/services/promosyon-kupa-2' },
      { name: 'tabela-cnc-3', path: 'img/services/tabela-cnc-3' },
      { name: 'tabela-forex-1', path: 'img/services/tabela-forex-1' },
      { name: 'tabela-kompozit-2', path: 'img/services/tabela-kompozit-2' },
      { name: 'tabela-kompozit-8', path: 'img/services/tabela-kompozit-8' },
      { name: 'tabela-kutuharf-4', path: 'img/services/tabela-kutuharf-4' },
      { name: 'tabela-pilon-6', path: 'img/services/tabela-pilon-6' },
      { name: 'tabela-totem-7', path: 'img/services/tabela-totem-7' },
      { name: 'tabela-vinyl-5', path: 'img/services/tabela-vinyl-5' },
    ];
  }
