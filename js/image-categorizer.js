...
class ImageCategorizer {
  ...
  getKnownImages() {
    return [
      { name: 'arac-kismi-2', path: 'img/Ürünler/arac-kismi-2.jpg' },
      { name: 'arac-kismi-3', path: 'img/Ürünler/arac-kismi-3.jpg' },
      { name: 'arac-tam-1', path: 'img/Ürünler/arac-tam-1.jpg' },
      { name: 'baski-afis-3', path: 'img/Ürünler/baski-afis-3.jpg' },
      { name: 'baski-afis-4', path: 'img/Ürünler/baski-afis-4.jpg' },
      { name: 'baski-folyo-1', path: 'img/Ürünler/baski-folyo-1.jpg' },
      { name: 'baski-poster-2', path: 'img/Ürünler/baski-poster-2.jpg' },
      { name: 'hediye-1', path: 'img/Ürünler/hediye-1.jpg' },
      { name: 'plaket-gümüş-2', path: 'img/Ürünler/plaket-gümüş-2.jpg' },
      { name: 'plaket-kadife-1', path: 'img/Ürünler/plaket-kadife-1.jpg' },
      { name: 'plaket-kristal-3', path: 'img/Ürünler/plaket-kristal-3.jpg' },
      { name: 'promosyon-ajanda-3', path: 'img/Ürünler/promosyon-ajanda-3.jpg' },
      { name: 'promosyon-çakmak-2', path: 'img/Ürünler/promosyon-çakmak-2.jpg' },
      { name: 'promosyon-kalem-1', path: 'img/Ürünler/promosyon-kalem-1.jpg' },
      { name: 'promosyon-kupa-2', path: 'img/Ürünler/promosyon-kupa-2.jpg' },
      { name: 'tabela-cnc-3', path: 'img/Ürünler/tabela-cnc-3.jpg' },
      { name: 'tabela-forex-1', path: 'img/Ürünler/tabela-forex-1.jpg' },
      { name: 'tabela-kompozit-2', path: 'img/Ürünler/tabela-kompozit-2.jpg' },
      { name: 'tabela-kompozit-8', path: 'img/Ürünler/tabela-kompozit-8.jpg' },
      { name: 'tabela-kutuharf-4', path: 'img/Ürünler/tabela-kutuharf-4.jpg' },
      { name: 'tabela-pilon-6', path: 'img/Ürünler/tabela-pilon-6.jpg' },
      { name: 'tabela-totem-7', path: 'img/Ürünler/tabela-totem-7.jpg' },
      { name: 'tabela-vinyl-5', path: 'img/Ürünler/tabela-vinyl-5.jpg' },
    ];
  }
